...
<main class="container mx-auto bg-gray-300  w-9/12">
        ...
        <section class="container mx-auto ">
            ...
            <div class="px-20 container relative mx-auto">
                ...
                <a  href="{{route('clientSessionsList', \Carbon\Carbon::now('Europe/Moscow')->locale('ru_RU')->format('Y-m-d'))}}"  class="uppercase  rounded-md px-8  py-3 text-white font-bold text-sm  bg-emerald-700 shadow-lg hover:bg-emerald-500  transition-all ease-in  delay-300  duration-200" >открыть продажу билетов</a>
                </div>
