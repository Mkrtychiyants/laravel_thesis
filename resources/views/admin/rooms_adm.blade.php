...
<main class="grid grid-cols-1 gap-0 auto-rows-max  justify-start lg:grid-cols-1">
        <section class="flex  flex-col container mx-auto items-start bg-white">
            <a  href="{{url ('/')}}" class="flex  w-full flex-col relative items-start " >
                    <div class="w-full flex content-center   flex-wrap bg-purple-700  indent-24 z-5  py-8 text-xl  text-white font-bold uppercase tracking-tighter">Управление залами        
        ...
        <a  href="{{route('show_room', 1)}}" class="flex bg-gray  flex-col relative items-start rounded-lg bg-white " >
